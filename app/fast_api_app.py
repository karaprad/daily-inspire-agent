    ...
    <main>
        ...
        <section>
            <div class="subscribe-card">
                ...
                <div style="background: rgba(255,255,255,0.03); border: 1px solid var(--border); border-radius: 12px; padding: 14px; margin-bottom: 20px; font-size: 0.85rem; line-height: 1.5; color: var(--text-secondary);">
                    🌐 <strong>Google Group:</strong><br>
                    Join directly at <a href="https://groups.google.com/g/inspiration-stories" target="_blank" style="color: var(--accent); text-decoration: underline;">groups.google.com/g/inspiration-stories</a><br><br>
                    📧 <strong>Via Email:</strong><br>
                    Send a blank email to:<br>
                    <a href="mailto:inspiration-stories+subscribe@googlegroups.com" style="color: var(--accent); word-break: break-all;">inspiration-stories+subscribe@googlegroups.com</a>
                </div>
